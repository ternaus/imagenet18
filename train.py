...
parser.add_argument("--name", type=str, default="imagenet", help="name of the current run, used for machine naming")
parser.add_argument("--run_name", type=str, default="", help="name of run for loggin")
parser.add_argument("--machines", type=int, default=1, help="how many machines to use")
parser.add_argument("--num_tasks", type=int, default=1, help="same as machines for compatibility, don't use")
parser.add_argument(
    "--mount_imagenet",
    type=int,
    default=1,
...
parser.add_argument("--offset", type=int, default=0, help="offset for imagenet ebs numbering")
parser.add_argument("--vmtouch", type=int, default=0, help="lock all examples into physical memory")
parser.add_argument(
    "--internal_config_fn",
    type=str,
    default="ncluster_config_dict",
    help="location of filename with extra info to log",
)
parser.add_argument(
    "--nproc_per_node", type=int, default=8, help="Processes per machine, must not exceed number of GPUS"
)
parser.add_argument("--image_name", type=str, default="pytorch-efa01", help="Image to use for this run")
...
eight_machines = [
    ...
    {"ep": (0, 6), "lr": (lr, lr * 2)},
    {"ep": 6, "bs": 256, "keep_dl": True, "lr": lr * 2},
    {"ep": (11, 14), "lr": (lr * 2, lr)},  # trying one cycle
    {"ep": 14, "sz": 224, "bs": 128, "trndir": "-sz/352", "min_scale": 0.087, "lr": lr},
...
schedules = {1: one_machine, 2: two_machines, 4: four_machines, 8: eight_machines, 16: sixteen_machines}
